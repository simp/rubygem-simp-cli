...
class Simp::Cli::Commands::Passgen < Simp::Cli::Commands::Command
  ...
  def parse_command_line(args)
    ...
    opt_parser = OptionParser.new do |opts|
      ...
      opts.separator '  simp passgen -E|-l|-n|-r|-s [OPTIONS]'
      opts.separator ''
      ...
      opts.separator '  simp passgen -n NAME1,NAME2,NAME3 -e dev'
      opts.separator ''
      ...
      opts.separator '  simp passgen -n admin --folder app1'
      opts.separator ''
      opts.separator '  # Remove specific passwords in the test environment.'
      opts.separator '  simp passgen -r NAME1,NAME2 -e test'
      opts.separator ''
      ...
      opts.separator '  simp passgen -s NAME1,NAME2,NAME3 --auto-gen'
      opts.separator ''
