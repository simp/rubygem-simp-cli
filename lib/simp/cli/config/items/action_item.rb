...
module Simp::Cli::Config
  ...
  module SafeApplying
    def safe_apply
      ...
      if !@allow_user_apply && (ENV.fetch('USER') != 'root')
        @skip_apply = true
        @skip_apply_reason ||= '[**user is not root**]'
      end
      ...
      if @skip_apply
        ...
        begin
          apply
          notice(@applied_status.to_s.capitalize.to_s, [status_color, :BOLD])
          if @applied_status == :failed
            raise ApplyError, apply_summary if @die_on_apply_fail
  ...
  class ActionItem < Item
    ...
    attr_accessor :applied_status, :applied_time, :applied_detail, :defer_apply, :skip_apply, :skip_apply_reason, :die_on_apply_fail, :allow_user_apply
