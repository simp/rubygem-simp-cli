...
class Simp::Cli::Config::Utils
  ...
  class << self
    ...
    def check_openldap_password(password, ssha)
      require 'base64'
      decoded = Base64.decode64(ssha.gsub(%r{^{SSHA}}, ''))
      decoded[0..19]
      salt = decoded[20..]
    ...
    def validate_username(username)
      ...
      !username.match(%r{^[a-z_]([a-z0-9_-]{0,31}|[a-z0-9_-]{0,30}\$)$}).nil?
    end
  end
end
