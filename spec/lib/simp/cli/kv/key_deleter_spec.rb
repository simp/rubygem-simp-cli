...
describe Simp::Cli::Kv::KeyDeleter do
  ...
  describe '#delete' do
    it 'removes key in the environment' do
      ...
      expect { @deleter.delete(key, false) }.not_to raise_error
    end
    ...
    it 'removes global key' do
      ...
      expect { @deleter.delete(key, true) }.not_to raise_error
    end
  ...
  describe '#delete_key' do
    it 'succeeds when #apply_manifest_with_spawn succeeds' do
      ...
      expect { @deleter.delete_key(key, true) }.not_to raise_error
    end
