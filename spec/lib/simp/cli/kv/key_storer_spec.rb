...
describe Simp::Cli::Kv::KeyStorer do
  ...
  before :each do
    ...
    @storer = described_class.new(@env, @backend)
  end
  ...
  describe '#put' do
    it 'sets non-binary key in the environment' do
      ...
      expect { @storer.put(*args) }.not_to raise_error
    end
  ...
  describe '#put_key' do
    it 'succeeds when #apply_manifest_with_spawn succeeds' do
      ...
      expect { @storer.put_key(*args) }.not_to raise_error
    end
  ...
  describe '#put_binary_key' do
    it 'succeeds when #apply_manifest_with_spawn succeeds' do
      ...
      expect { @storer.put_binary_key(*args) }.not_to raise_error
    end
